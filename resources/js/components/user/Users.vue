                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-0">
                                ...
                                <button class="btn btn-success" @click="showCreateData()">
                                ...
                                <tr>
                                    ...
                                    <tbody>
                                        <tr v-for="data in datas.data" :key="data.id">
                                            ...
                                            <td> 
                                                <a href="#" @click="showUpdateData(data)">
                                                    <i class="fas fa-edit text-info"></i>
                                                </a>
                                                /
                                                <a href="#"   @click="deleteData(data)">
...
<script>
    ...
    let actions = {
        ...
        methods: {
            ...
            fetchData() {
                this.$Progress.start()
                this.$store.dispatch('fetchData',this.url).then(response => {
            ...
            updateDate(){
                ...
                console.log("url:"+this.url + '/' + this.form.id);
                console.log(this.form);
                this.$Progress.start();
                // axios.put(this.url + '/' + this.form.id, this.form)
                //     .then(response => {
                //         console.log("response");
                //         console.log(response);
                //         this.$Progress.finish();
                ...
                this.$store.dispatch('updateData', [this.url,this.form])
                .then(response => {
                    this.form.reset();
                    this.statusModule('hide');
                    this.$Progress.finish();
